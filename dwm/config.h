...
/* tagging */
static const char *tags[] = { " ", " ", "󱍚 ", " ", "5", "6", "7", "8", "9" };
...
static const char *dmenucmd[] = { "dmenu_run", "-c", "-g", "4", "-l", "10", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
