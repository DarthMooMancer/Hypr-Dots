...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { foreground_sel, workspace_sel, win_border_sel },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", background, "-nf", foreground, "-sb", workspace_sel, "-sf", foreground_sel, NULL };
...
static const Key keys[] = {
	...
	{ 0, XF86XK_MonBrightnessUp,		spawn, SHCMD("sh ~/scripts/backlight-up.sh") },
	{ 0, XF86XK_MonBrightnessDown,		spawn, SHCMD("sh ~/scripts/backlight-down.sh") },
